...
- (void)viewWillAppear:(BOOL)animated {
    ...
    if ([savedFeedResources count] == 0) {
        FeedResource* defaultResource = [[FeedResource alloc] initWithID:[NSUUID UUID] name:DEFAULT_RESOURCE_NAME url:[NSURL URLWithString:DEFAULT_URL_TO_PARSE]];
                                                         ...
                                                         style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
                                                             ...
                                                             if (![feedTextField.text isEqualToString:@""] && ![urlTextField.text isEqualToString:@""]) {
                                                                 ...
                                                                 if (urlForParse) {
                                                                     ...
                                                                     //FeedResource* resource = [self.feedResourceService addFeedResource:[[FeedResource alloc] initWithID:[NSUUID UUID] name:feedTextField.text url:urlForParse]];
                                                                     //self.feedsResources = [self.feedResourceService feedResources];
                                                                     FeedResource* resource = [self.feedResourceServiceFactory addFeedResource:[[FeedResource alloc] initWithID:[NSUUID UUID] name:feedTextField.text url:urlForParse]];
                                                                     self.feedsResources = [self.feedResourceServiceFactory feedResources];
