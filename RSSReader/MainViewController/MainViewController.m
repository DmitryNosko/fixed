...
- (void)viewDidLoad {
    ...
    //self.feedItemService = [[FeedItemServiceFactory sharedFeedItemServiceFactory] feedItemServiceProtocol:storageStrategyID];
    //self.feedResourceService = [[FeedResourceServiceFactory sharedFeedResourceServiceFactory] feedResourceServiceProtocol:storageStrategyID];
...
//        NSMutableArray<FeedItem *>* itemsToSort = [self.feedItemService feedItemsForResources:[[NSMutableArray alloc] initWithArray:[self.feedResourceByURL allValues]]];
...
- (void) setUpSettingsView {
    ...
    self.switchStorageSegmentController = [[UISegmentedControl alloc] initWithItems:@[@"fileStorage", @"SQLStorage"]];
    ...
    if ([NSUserDefaults.standardUserDefaults objectForKey:@"dataSourceStrategyID"]) {
        [self.switchStorageSegmentController setSelectedSegmentIndex:[[NSUserDefaults.standardUserDefaults objectForKey:@"dataSourceStrategyID"] integerValue]];
    } else {
        [self.switchStorageSegmentController setSelectedSegmentIndex:0];
        [NSUserDefaults.standardUserDefaults setObject:DEFAULT_STORAGE_INDEX forKey:@"dataSourceStrategyID"];
        [NSUserDefaults.standardUserDefaults synchronize];
    }
...
- (void) changeStorage:(UISegmentedControl *) sender {
    ...
    //[[[[DataSourceMigratorFactory1 alloc] initWithStorageValue:dataSourceStrategyID] dataSourceMigratorProtocol] migrateData];
    ...
    [NSUserDefaults.standardUserDefaults setObject:dataSourceStrategyID forKey:@"dataSourceStrategyID"];
    [NSUserDefaults.standardUserDefaults synchronize];
}
